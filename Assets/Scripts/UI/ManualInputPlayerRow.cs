...
public class ManualInputPlayerRow : MonoBehaviour
{
    ...
    private Action<ManualInputPlayerRow, bool> onSelectionChanged;

    public void Initialize(PlayerData playerData, int index, Action<ManualInputPlayerRow, bool> selectionCallback)
    {
        player = playerData;
        playerIndex = index;
